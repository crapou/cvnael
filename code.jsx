...
const D = {
  ...
  photos: [
    { id: 1, alt: "Singapour — Alstom" }, { id: 2, alt: "Paris Coffee Festival" },
    { id: 3, alt: "IAE Aix-Marseille" }, { id: 4, alt: "MDI Gurgaon — Inde" },
    { id: 5, alt: "Événementiel BRITA" }, { id: 6, alt: "Projets Innovation" },
  ],
};
      ...
      <section style={{ position: "relative", padding: "100px 24px 80px", overflow: "hidden", background: `linear-gradient(135deg, ${britaBlue} 0%, ${britaLight} 100%)` }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: "rgba(255,255,255,.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#fff", fontFamily: "'Satoshi',sans-serif", backdropFilter: "blur(8px)", letterSpacing: ".05em" }}>
              BRITA
            </div>
            <div>
          ...
          {/* Image placeholders — BRITA salon photo */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 32, maxWidth: 600 }}>
            <div style={{ height: 140, borderRadius: 16, background: "rgba(255,255,255,.1)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, color: "rgba(255,255,255,.5)", fontWeight: 600, border: "1px solid rgba(255,255,255,.1)" }}>
              📷 Stand BRITA — Salon SETA
            </div>
            <div style={{ height: 140, borderRadius: 16, background: "rgba(255,255,255,.1)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, color: "rgba(255,255,255,.5)", fontWeight: 600, border: "1px solid rgba(255,255,255,.1)" }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <A delay={0.1}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 14, marginTop: 32 }}>
              {["📷 Campagne « Drink better »", "📷 Stand BRITA — Salon", "📷 Container concept 2026"].map((label, i) => (
                <div key={i} style={{ height: 180, borderRadius: 16, background: G[i], display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${t.bd}` }}>
                  <span style={{ color: "rgba(255,255,255,.5)", fontSize: 13, fontWeight: 600, background: "rgba(0,0,0,.2)", padding: "8px 16px", borderRadius: 980, textAlign: "center" }}>{label}</span>
                </div>
              ))}
            </div>
          </A>
  ...
  return (
    <div style={{ background: t.bg, minHeight: "100vh", transition: "background .5s" }}>
      ...
      <section style={{ position: "relative", minHeight: "100vh", overflow: "hidden", background: leakoGrad, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "clamp(40px,8vw,100px)", maxWidth: 1100, padding: "120px 24px 80px", position: "relative", zIndex: 2, flexWrap: "wrap" }}>
          {/* Left — Title */}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {/* Replace this div with: <video src="YOUR_VIDEO_URL" autoPlay muted loop playsInline style={{width:"100%",height:"100%",objectFit:"cover"}} /> */}
                  <div style={{
                    width: 56, height: 56, borderRadius: "50%",
                    background: "linear-gradient(135deg, #667eea, #764ba2)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    boxShadow: `0 0 30px ${leakoBlue}44`,
                    marginBottom: 12,
                  }}>
                    <span style={{ fontSize: 24, fontWeight: 900, color: "#fff", fontFamily: "'Satoshi',sans-serif" }}>L</span>
                  </div>
                  <span style={{ fontSize: 18, fontWeight: 800, color: "#fff", fontFamily: "'Satoshi',sans-serif", letterSpacing: "-.02em" }}>Leako</span>
                  <span style={{ fontSize: 10, color: "rgba(255,255,255,.4)", marginTop: 6 }}>📹 Vidéo bientôt disponible</span>

                  {/* Fake UI elements */}
                  <div style={{ position: "absolute", bottom: 16, left: 16, right: 16, display: "flex", flexDirection: "column", gap: 6 }}>
                    <div style={{ height: 28, borderRadius: 8, background: "rgba(255,255,255,.06)" }} />
                    <div style={{ display: "flex", gap: 6 }}>
                      <div style={{ flex: 1, height: 28, borderRadius: 8, background: "rgba(102,126,234,.2)" }} />
                      <div style={{ flex: 1, height: 28, borderRadius: 8, background: "rgba(255,255,255,.04)" }} />
                    </div>
                  </div>
                </div>
...
export default function Portfolio() {
  ...
  const css = `
    ...
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    @media(max-width:768px){.d-nav{display:none!important}.mob-btn{display:flex!important}.hero-btns{flex-direction:column;width:100%}.hero-btns a{width:100%;justify-content:center}.proj-g{grid-template-columns:1fr!important}.ph-g{grid-template-columns:1fr 1fr!important}.ph-g .photo-item:nth-child(1){grid-row:span 1}.sk-g{grid-template-columns:1fr!important}.stat-row{flex-direction:column;gap:24px!important}}
        ...
        <section id="hero" style={{ position:"relative",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",padding:"120px 24px 80px" }}>
          ...
          <div style={{ textAlign:"center",position:"relative",zIndex:2,maxWidth:800 }}>
            <div style={{ position:"relative",width:130,height:130,margin:"0 auto 28px",animation:"slideUp .8s .1s both" }}>
              ...
              <div style={{ width:130,height:130,borderRadius:"50%",background:`linear-gradient(135deg,${t.ac},${t.ac2})`,border:`3px solid ${t.bd}`,boxShadow:`0 0 0 8px ${t.acS}, 0 10px 40px ${t.ac}22`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:52,color:"#fff",fontFamily:"'Satoshi',sans-serif",fontWeight:900 }}>N</div>
            </div>
        ...
        <section id="gallery" style={{ padding:"120px 24px",background:t.bgS,transition:"background .5s" }}>
          <div style={{ maxWidth:1200,margin:"0 auto" }}>
            ...
            <div className="ph-g" style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginTop:40 }}>
              {D.photos.map((p,i)=>(<A key={p.id} delay={i*.06}><div className="photo-item" style={{ background:g(i),display:"flex",alignItems:"center",justifyContent:"center" }}><span style={{ color:"rgba(255,255,255,.5)",fontSize:13,fontWeight:600,background:"rgba(0,0,0,.2)",padding:"7px 16px",borderRadius:980 }}>{p.alt}</span></div></A>))}
            </div>
          </div>
        </section>
